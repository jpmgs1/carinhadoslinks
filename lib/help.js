...
_ℹ️ - Grupo oficial do programador deste bot!_ */Carinha*
_ℹ️ - Se quiser saber do bot ou como construir "ele", use_ *.About* .
_ℹ️ - Caso algum comando não funcione significa que o servidor caiu e é necessario esperar que volte._

*1 - ${prefix}simi (mensagem)*
...
function donate() {
    return `
_Não é necessário, mas caso você queira contibuir chame o criador pelo WhatsApp_ wa.me/+558293767174.
❤️`
}
