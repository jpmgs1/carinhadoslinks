/*
* Recodado por Carinha dos links
...
module.exports = kconfig = async (kill, message) => {
    try {
		...
		case 'legiao':
			...
			await kill.sendLinkWithAutoPreview(from, 'https://chat.whatsapp.com/FclVqIxKGyUCpauOeD4Qb1', 'Que otimo que se interessou pelo Legião Z!\nAi está nosso grupo!', id)
			break
